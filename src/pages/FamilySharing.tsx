    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading family sharing...</p>
        </div>
      </div>
    );
  }
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Invite family members and caregivers to share and update your baby's records. All data syncs instantly across devices.
          </p>
        </div>

        {/* Family Sharing Content */}
        {profile ? (
          <FamilySharingCard babyId={profile.id} />
        ) : (
          <div className="text-center py-12">
            <Users className="h-16 w-16 text-gray-400 mx-auto mb-4" />
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Baby Profile Found</h3>
            <p className="text-gray-600 mb-4">Create a baby profile to start family sharing.</p>
