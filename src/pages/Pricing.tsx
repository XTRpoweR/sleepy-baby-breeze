                  ...
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="text-center py-3 md:py-4 px-2 md:px-4">
                      {typeof row.basic === 'boolean' ? (
                        row.basic ? <Check className="h-4 w-4 md:h-5 md:w-5 text-green-500 mx-auto" /> : <X className="h-4 w-4 md:h-5 md:w-5 text-gray-400 mx-auto" />
                      ) : (
                    ...
                    <td className="text-center py-3 md:py-4 px-2 md:px-4">
                      {typeof row.premium === 'boolean' ? (
                        row.premium ? <Check className="h-4 w-4 md:h-5 md:w-5 text-green-500 mx-auto" /> : <X className="h-4 w-4 md:h-5 md:w-5 text-gray-400 mx-auto" />
                      ) : (
