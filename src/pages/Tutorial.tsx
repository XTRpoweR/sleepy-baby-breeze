...
import { Moon, ArrowLeft, ArrowRight, Play, CheckCircle, Baby, Activity, BarChart3, Users, Calendar, Volume2, Clock } from 'lucide-react';
...
const Tutorial = () => {
  ...
  const tutorialSteps = [{
    ...
    bgColor: 'bg-blue-50',
    estimatedTime: '5 min',
    content: [t('tutorial.steps.setup.step1'), t('tutorial.steps.setup.step2'), t('tutorial.steps.setup.step3'), t('tutorial.steps.setup.step4')],
    ...
    content: [t('tutorial.steps.tracking.step1'), t('tutorial.steps.tracking.step2'), t('tutorial.steps.tracking.step3'), t('tutorial.steps.tracking.step4')],
    ...
    estimatedTime: '7 min',
    content: [t('tutorial.steps.reports.step1'), t('tutorial.steps.reports.step2'), t('tutorial.steps.reports.step3'), t('tutorial.steps.reports.step4')],
    ...
    estimatedTime: '8 min',
    content: [t('tutorial.steps.advanced.step1'), t('tutorial.steps.advanced.step2'), t('tutorial.steps.advanced.step3'), t('tutorial.steps.advanced.step4')],
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="flex items-center space-x-4 overflow-x-auto pb-2">
            ...
            return <button key={step.id} onClick={() => setCurrentStep(index)} className={`flex flex-col items-center space-y-2 p-4 rounded-lg transition-all min-w-[120px] ${isActive ? 'bg-white shadow-lg border-2 border-blue-200' : 'bg-white/50 hover:bg-white hover:shadow-md'}`}>
                  <div className={`p-3 rounded-full ${step.bgColor} relative`}>
                    <StepIcon className={`h-6 w-6 ${step.color}`} />
                    {isCompleted && <CheckCircle className="h-4 w-4 text-green-600 absolute -top-1 -right-1 bg-white rounded-full" />}
                  </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-4">
              {currentTutorial.content.map((item, index) => <div key={index} className="flex items-start space-x-3">
              ...
              <div className="pt-4 space-y-3">
                ...
                <Button variant="outline" onClick={() => markStepCompleted(currentTutorial.id)} className="w-full">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="text-center">
            ...
            {completedSteps.length === tutorialSteps.length && <Badge className="bg-green-100 text-green-800">
                {t('tutorial.allCompleted')}
              </Badge>}
          </div>

          <Button onClick={nextStep} disabled={currentStep === tutorialSteps.length - 1} className="flex items-center space-x-2">
