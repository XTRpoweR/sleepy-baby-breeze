...
export const QuickLogCard = () => {
  ...
  return (
    <Card 
      className="hover:shadow-lg transition-shadow cursor-pointer bg-gradient-to-br from-green-50 to-blue-50 border-green-200 touch-target"
      onClick={handleClick}
    >
      <CardContent className="p-4 lg:p-6 text-center">
        <div className="bg-green-100 rounded-full w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center mx-auto mb-3 lg:mb-4">
          <div className="relative">
            ...
            <Music className="h-3 w-3 lg:h-4 lg:w-4 text-green-700 absolute -top-1 -right-1" />
          </div>
        </div>
