...
const LOCALES: Record<LocaleKey, Locale> = {
  en: {
    ...
    intro: "Thanks for subscribing to the SleepyBabyy newsletter. You'll now receive expert tips, science-backed insights, and practical advice to help your little one (and you) sleep better.",
    feat1Title: "Weekly sleep tips", feat1Desc: "Curated advice from pediatric sleep experts",
  ...
  de: {
    ...
    intro: "Danke, dass du den SleepyBabyy-Newsletter abonniert hast. Du bekommst ab jetzt Experten-Tipps, wissenschaftlich fundierte Einblicke und praktische Ratschläge, damit dein Kleines (und du) besser schlafen.",
    feat1Title: "Wöchentliche Schlaftipps", feat1Desc: "Ausgewählte Ratschläge von Schlafexperten",
  ...
  es: {
    ...
    intro: "Gracias por suscribirte al boletín de SleepyBabyy. Recibirás consejos de expertos, datos respaldados por la ciencia y orientación práctica para que tu pequeño (y tú) descanséis mejor.",
    feat1Title: "Consejos semanales", feat1Desc: "Recomendaciones de expertos en sueño infantil",
  ...
  fr: {
    ...
    intro: "Merci de votre inscription à la newsletter SleepyBabyy. Vous recevrez des conseils d'experts, des informations fondées sur la science et des astuces concrètes pour mieux dormir, vous et votre bébé.",
    feat1Title: "Conseils hebdomadaires", feat1Desc: "Conseils d'experts du sommeil pédiatrique",
  ...
  it: {
    ...
    intro: "Grazie per esserti iscritto alla newsletter di SleepyBabyy. Riceverai consigli di esperti, approfondimenti scientifici e suggerimenti pratici per aiutare il tuo piccolo (e te) a dormire meglio.",
    feat1Title: "Consigli settimanali", feat1Desc: "Selezionati da esperti del sonno pediatrico",
  ...
  el: {
    ...
    intro: "Ευχαριστούμε που εγγράφηκες στο newsletter του SleepyBabyy. Από εδώ και στο εξής θα λαμβάνεις συμβουλές από ειδικούς και πρακτικές οδηγίες για να κοιμάστε καλύτερα εσύ και το μωρό σου.",
    feat1Title: "Εβδομαδιαίες συμβουλές", feat1Desc: "Από ειδικούς στον παιδικό ύπνο",
    ...
    intro: "Kiitos, että tilasit SleepyBabyy-uutiskirjeen. Saat asiantuntijavinkkejä, tutkittua tietoa ja käytännön neuvoja, joilla pienesi (ja sinä) nukutte paremmin.",
    feat1Title: "Viikoittaiset univinkit", feat1Desc: "Lasten uniasiantuntijoilta",
  ...
  sv: {
    ...
    intro: "Tack för att du prenumererar på SleepyBabyy-nyhetsbrevet. Du får expertråd, vetenskapligt grundade insikter och praktiska tips som hjälper din lilla (och dig) att sova bättre.",
    feat1Title: "Veckovisa sömntips", feat1Desc: "Utvalda råd från barnsömnsexperter",
